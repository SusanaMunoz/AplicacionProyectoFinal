...
public class ResumenMensualWorker extends Worker {

    public ResumenMensualWorker(Context context, WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        if (correoUsuario != null) {
            String mensaje = obtenerResumen("mensual");
            EmailUtil.enviarCorreo(correoUsuario, "Resumen Mensual", mensaje);
